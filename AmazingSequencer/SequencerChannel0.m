 ...
 */
@implementation SequencerChannel0 {
...
+ (instancetype)sequencerChannelWithAudioFileAt:(NSURL *)url audioController:(AEAudioController*)audioController repeatAtBPM:(UInt64)bpm {
    ...
    SequencerChannel0 *channel = [[self alloc] init];
...
static OSStatus renderCallback(__unsafe_unretained SequencerChannel0 *THIS,
